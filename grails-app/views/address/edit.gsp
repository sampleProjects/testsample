			...
			<div id="edit-address" class="content scaffold-edit" role="main">
				...
				<g:form url="[resource:addressInstance, action:'update']" method="PUT" >
					...
					<div class="col-sm-12 text-center btn-space">
						...
						<g:link class="btn btn-success" action="delete" id="${addressInstance?.id}" onclick="return confirmDelete()"><g:message code="default.delete.label" default="Delete" /></g:link>	
					</div>
					</div>
					
					
					<div class="col-xs-12">
						<g:render template="/common/returnLink" model="['returnAction': 'edit', 'returnController': 'customer', 'messageCode':'etech.customer.return.screen', 'defaultMessage': 'Return to customer Screen', 'linkId': addressInstance?.customer?.id, 'isDirtyCheck': 'isDirtyCheck']"></g:render> 
					</div>	
				</g:form>
			</div>
		</div>
