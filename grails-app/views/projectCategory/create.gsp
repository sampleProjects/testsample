...
<html>
	...
	<body>
		<div class="navigation">
			<g:set var="action" value="${message(code: 'projectcategory.add.label', default: 'Add')}" />
			<h3><g:message code="etech.projectcategory.maintenance.label" default="Project Category Maintenance" /></h3>
		</div>
		
		
			<div class="white-bg">
				<div class="title">
					<h2><g:if test="${params?.previousAction == 'newRecord' || projectCategoryInstance?.hasErrors() }"><g:message code="default.sub.title.create.label" default= "Create" /></g:if><g:else><g:message code="default.sub.title.search.label" default= "Search" /></g:else></h2>
				</div>
				...
				<g:form method="post" name="createForm" controller="projectCategory">
					<fieldset class="form">
