...
<body>
	<div class="navigation">	
		<h3> <g:message code="etech.project.employee.activity.label" default="Employee Activity for" />  ${projectInstance?.name} ( ${projectInstance?.name} ) </h3>		
	</div>	
	<div class="col-sm-12" role="main">			
		<div class="white-bg">		
			<div class="title"><h2> <g:message code="etech.project.employee.activity.list.label" default="Employee Activity List" /></h2></div>
          	<div>
				<div class="col-xs-12">
					<div>
				...
				<g:render template="/common/returnLink" model="['returnAction': 'getAllActualLaborEmployeeListPage', 'returnController': 'report', 'messageCode':'etech.project.employee.return.screen', 'defaultMessage': 'Return to Project Employee Screen', 'linkId': projectInstance?.id, 'linkParam': ['costOption': params?.costOption]]"></g:render>
