		...
		<div class="modal-content">
			...
			<div class="modal-body">       
	        	...
	        	<div class="row">        	 
					...
					<div class="col-sm-4 col-md-4 margintop25">
						<div class="form-group">
							...
							<input type="button" onclick="${remoteFunction(action: 'getEmployeeListWithoutUser', controller: 'user', update: 'employeeListGridDiv', onSuccess: 'employeeSuccessSearch(data)', 
				...
				<div id="employeeListGridDiv">		
				 	<g:render template="ajaxEmployeeList"/>
			    </div>
