<!-- Modal -->
<div class="modal fade dialog-box" id="customerCodeDialog" role="dialog">
			...
			<div class="modal-body">       
	        	...
	        	<div class="row">        	 
					...
					<div class="col-sm-3 col-md-3">
						<label for="dialogCustomerCode"><g:message code="etech.customer.code.label" default="Code" /></label>
						<g:textField name="dialogCustomerCode" value="" class="form-control"/>					
					</div>
			
					<div class="col-sm-3 col-md-3">					
						<label for="dialogCustomerName"><g:message code="etech.customer.name.label" default="Name" /></label>
					...
					<div class="col-sm-4 col-md-4 margintop25">
						<div class="form-group">
							...
							<input type="button" onclick="${remoteFunction(action: 'getCustomerList', controller: 'project', update: 'customerCodelistGridDiv', onSuccess: 'customerSuccessSearch(data)', 
			           		 ...
			           		 <input type="button" class="btn btn-success search-btn" onclick="resetCustomerCodeDialog()" value="Reset"/>
				...
				<div id="customerCodelistGridDiv">		
				 	<g:render template="customerCodeList"/>
			    </div>
