...
<g:render template="/common/paginationCombo" model="['totalRecord':customerInstanceCount, 'searchAction': 'getCustomerList', 'searchController': 'project', 'divIdToUpdate': 'customerCodelistGridDiv']"></g:render>
  		...
  		<table class="table table-striped">	
			<thead>
				<tr>
					...
					<th><g:message code="etech.customer.customerName.label" default="Name" /></th>
	...
	<g:render template="/common/ajaxSortingAndPaging" model="['searchAction': 'getCustomerList', 'searchController': 'project', 'divIdToUpdate': 'customerCodelistGridDiv', 'searchParams': 'true']" />			
