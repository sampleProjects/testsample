(function($) {
	$.fn.createScrollableTable = function(options) {
		...
		function getWidth(td) {
			if (false || !!document.documentMode) { return $(td).outerWidth() - 1; }
			if (typeof InstallTrigger !== 'undefined') { return $(td).width(); }
			if (Object.prototype.toString.call(window.HTMLElement).indexOf('Constructor') > 0) { return $(td).outerWidth(); }
